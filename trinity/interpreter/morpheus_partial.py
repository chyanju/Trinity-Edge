...
logger = get_logger("trinity.morpheus_partial_interpreter")
profiler = get_logger("trinity.morpheus_partial_interpreter")
...
class MorpheusPartialInterpreter(PartialInterpreter):
    '''
